...
export default function LayoutPopup({
  ...
  return (
    <div className="w-full h-fit max-h-full shrink-0 bg-white/95 backdrop-blur-md rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.08)] border border-gray-100/80 overflow-hidden flex flex-col z-20 transition-all duration-300">
      <div className="p-4 pb-3 flex justify-between items-center border-b border-gray-100">
        <div className="flex items-center gap-2">
          <h2 className="text-lg font-bold text-gray-900 m-0">Layouts</h2>
          <span className="text-xs bg-orange-50 text-[#c05520] px-2 py-0.5 rounded-md font-bold">
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50/70 flex flex-col gap-2.5">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-gray-800">
              Layout Cap Settings ({getCleanCapFileName(selectedCapUrl)})
            </span>
            <div className="flex items-center gap-1.5">
              <button
                type="button"
