...
export default function ScenePopup({
  ...
  return (
    <div className="w-full h-full shrink-0 bg-white/95 backdrop-blur-md rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.08)] border border-gray-100/80 overflow-hidden flex flex-col z-20 transition-all duration-300">
      <div className="p-4 border-b border-gray-100 flex items-center justify-between">
        <h2 className="text-lg font-bold text-gray-900 m-0">Environment</h2>
